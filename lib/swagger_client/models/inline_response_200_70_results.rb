...
module SwaggerClient
  class InlineResponse20070Results
    attr_accessor :ae
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::InlineResponse20070Results` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::InlineResponse20070Results`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [ae, ar, at, au, ba, bb, be, bg, bo, br, bs, ca, ch, ci, cl, co, cr, cz, de, dk, _do, dz, ec, eg, es, fi, fr, gb, gf, gh, gq, gt, hk, hn, hr, hu, id, ie, il, iq, it, jm, jp, ke, kr, lb, lt, ly, md, mk, mu, mx, my, mz, ne, ng, nl, no, nz, pa, pe, ph, pl, ps, pt, py, ro, rs, ru, sa, sc, se, sg, si, sk, sn, sv, th, tr, tt, tw, tz, ug, us, uy, ve, za, zm].hash
    end
