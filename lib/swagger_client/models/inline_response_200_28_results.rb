...
module SwaggerClient
  class InlineResponse20028Results
    attr_accessor :ae
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::InlineResponse20028Results` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::InlineResponse20028Results`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'al')
        self.al = attributes[:'al']
      end
      ...
      if attributes.key?(:'bh')
        self.bh = attributes[:'bh']
      end
      ...
      if attributes.key?(:'ee')
        self.ee = attributes[:'ee']
      end
      ...
      if attributes.key?(:'fj')
        self.fj = attributes[:'fj']
      end
      ...
      if attributes.key?(:'gi')
        self.gi = attributes[:'gi']
      end
      ...
      if attributes.key?(:'jo')
        self.jo = attributes[:'jo']
      end
      ...
      if attributes.key?(:'kw')
        self.kw = attributes[:'kw']
      end
      ...
      if attributes.key?(:'mt')
        self.mt = attributes[:'mt']
      end
      ...
      if attributes.key?(:'om')
        self.om = attributes[:'om']
      end
      ...
      if attributes.key?(:'qa')
        self.qa = attributes[:'qa']
      end
      ...
      if attributes.key?(:'ye')
        self.ye = attributes[:'ye']
      end
    ...
    def hash
      [ae, al, ar, at, au, ba, bb, be, bg, bh, bo, br, bs, ca, ch, cl, co, cr, cv, cz, de, dk, _do, ec, ee, eg, es, fi, fj, fr, gb, gf, gi, gr, gt, hk, hn, hr, hu, id, ie, il, _in, iq, is, it, jm, jo, jp, kr, kw, lb, li, lt, lv, md, mk, mt, mu, mx, my, mz, nl, no, nz, om, pa, pe, ph, pk, pl, ps, pt, py, qa, ro, rs, ru, sa, se, sg, si, sk, sm, sv, th, tr, tt, tw, ug, us, uy, ve, ye, za].hash
    end
