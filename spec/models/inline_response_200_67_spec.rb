...
# Unit tests for SwaggerClient::InlineResponse20067
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20067' do
  before do
    # run before each test
    @instance = SwaggerClient::InlineResponse20067.new
  end
  ...
  describe 'test an instance of InlineResponse20067' do
    it 'should create an instance of InlineResponse20067' do
      expect(@instance).to be_instance_of(SwaggerClient::InlineResponse20067)
    end
  end
