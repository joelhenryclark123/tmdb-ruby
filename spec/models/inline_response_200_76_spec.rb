...
# Unit tests for SwaggerClient::InlineResponse20076
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20076' do
  before do
    # run before each test
    @instance = SwaggerClient::InlineResponse20076.new
  end
  ...
  describe 'test an instance of InlineResponse20076' do
    it 'should create an instance of InlineResponse20076' do
      expect(@instance).to be_instance_of(SwaggerClient::InlineResponse20076)
    end
  end
